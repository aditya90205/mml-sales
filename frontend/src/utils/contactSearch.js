  ...
  for (const [stageId, list] of Object.entries(byStage || {})) {
    for (const lead of list || []) {
      ...
      rows.push({
        ...
        enquiryBy: lead.enquiryBy || extra.enquiryBy || lead.relation || extra.relation || "",
        nri: lead.nri || extra.nri || "",
        country: lead.country || extra.country || "",
        profession: lead.profession || extra.profession || "",
        familyIncomeBand: lead.familyIncomeBand || extra.familyIncomeBand || "",
        meeting: lead.meeting || extra.meeting || "",
        source: lead.source || extra.source || "",
        intakeValues: lead.intakeValues || null,
