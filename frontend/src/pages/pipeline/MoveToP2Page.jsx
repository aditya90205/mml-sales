...
export default function MoveToP2Page({ lead, onBack, onMoveToP2 }) {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 bg-[#F8F9FA]">
      <TopBar page="Pipeline Board / Move to P2" />
      ...
      {/* Smart Attach Banner */}
      <div className="px-6 pt-5 pb-1 max-w-[1450px]">
        ...
        <div className="bg-white border border-black/8 rounded-2xl p-6 shadow-xs flex flex-col gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-[13.5px] font-bold text-[#111]">Already Known - From P0 / P1</h3>
              <span className="text-[10.5px] text-[#9CA3AF]">Captured earlier</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3.5">
              ...
              <div>
                <label className="block text-[11.5px] font-semibold text-[#374151] mb-1.5">Occupation</label>
                <input
                  type="text"
                  name="occupation"
              ...
              <div>
                <label className="block text-[11.5px] font-semibold text-[#374151] mb-1.5">City/area</label>
                <input
                  type="text"
                  name="city"
                  value={formData.city}
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-[13.5px] font-bold text-[#111]">Bio Data - From Client</h3>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="sm:col-span-2">
                <label className="block text-[11.5px] font-semibold text-[#374151] mb-1.5">Partner preference notes</label>
                <input
                  type="text"
                  name="partnerNotes"
                  placeholder="Not set"
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-[13.5px] font-bold text-[#111]">Assignment & Content</h3>
            </div>
