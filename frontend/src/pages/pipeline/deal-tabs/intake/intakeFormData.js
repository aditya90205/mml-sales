...
import { LEAD_INCOME_BANDS, LEAD_OCCUPATIONS, LEAD_RELATIONS } from "../../../../utils/leadFields.js";
...
const BASIC_FORM_COUNTRIES = ["India", "USA", "UK", "Canada", "UAE", "Australia", "Singapore", "Other"];
const BASIC_FORM_SOURCES = [
  "Website Inquiry",
  "Referral",
  "Walk-in",
  "Campaign",
...
const BASIC_FORM_MEETINGS = ["Meeting Agreed", "Call Agreed", "Callback Later", "Not Yet"];
...
const PERSONAL_DETAILS_BLOCKS = [
  {
    ...
    fields: [
      ...
      { key: "enquiryBy", label: "Enquiry made by", required: true, type: "select", options: LEAD_RELATIONS },
      ...
      { key: "familyIncomeBand", label: "Family income bracket", type: "select", options: LEAD_INCOME_BANDS },
      { key: "leadSource", label: "Source", required: true, type: "select", options: BASIC_FORM_SOURCES },
      { key: "meeting", label: "Agree to a meeting or call", required: true, type: "pill", options: BASIC_FORM_MEETINGS },
      { key: "extraInfo", label: "Additional notes", type: "textarea", fullWidth: true },
    ],
  },
  {
    title: "Who is this",
...
/** Flat map of personal field key ? label (for change summary / OTP diffs). */
...
export const DEMO_PERSONAL_VALUES = {
  ...
  familyIncomeBand: "?30 Lakh to ?50 Lakh",
  leadSource: "Referral",
