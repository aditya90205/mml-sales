...
export default function MoveToP1Modal({ isOpen, lead, onClose, onMoveToP1 }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fadeIn">
      <div className="bg-[#FBFBFC] rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.18)] border border-black/8 w-full max-w-[1050px] max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-black/8 shrink-0">
          <h2 className="text-[19px] font-bold text-[#111]">Complete the details to proceed for P1</h2>
        ...
        {/* Form Body */}
        <div className="p-6 overflow-y-auto scrollbar-thin grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6">
          ...
          <div className="bg-white border border-black/8 rounded-2xl p-5 shadow-xs flex flex-col gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-[13px] font-bold text-[#111]">Already Known - From P0</h3>
                <span className="text-[10px] text-[#9CA3AF]">Captured at intake</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                ...
                <div>
                  <label className="block text-[11.5px] font-semibold text-[#374151] mb-1">Email</label>
                  <input
                    type="email"
                    name="email"
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-[13px] font-bold text-[#111]">Qualifying Details - From this Call</h3>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                ...
                <div>
                  <label className="block text-[11.5px] font-semibold text-[#374151] mb-1">Whom are you looking for</label>
                  <select
                    name="lookingFor"
                ...
                <div>
                  <label className="block text-[11.5px] font-semibold text-[#374151] mb-1">Enquiry made by</label>
                  <select
                    name="enquiryBy"
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-[13px] font-bold text-[#111]">NRI</h3>
              </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Ask AI Card */}
            <div className="bg-white border border-[#E0E7FF] rounded-2xl p-4 shadow-xs flex flex-col gap-3">
              <div className="flex items-start justify-between">
                <h4 className="text-[13px] font-bold text-[#111] leading-snug">
                  Draft a mail to request the missing details from the client - Ask AI
                </h4>
                <Sparkles size={16} className="text-[#6366F1] shrink-0 mt-0.5" />
              </div>
              ...
              <div className="bg-[#F5F3FF] border border-[#DDD6FE] rounded-xl p-3">
                <p className="text-[10px] font-semibold text-[#6D28D9] mb-1.5">Missing details detected</p>
                <div className="flex items-center gap-1.5 flex-wrap">
                  <span className="bg-[#EDE9FE] text-[#6D28D9] text-[10.5px] font-medium px-2 py-0.5 rounded-md">
                    Alternate Contact
                  </span>
                  <span className="bg-[#EDE9FE] text-[#6D28D9] text-[10.5px] font-medium px-2 py-0.5 rounded-md">
                    City / Area
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 h-9 rounded-xl border border-[#6366F1] text-[#4F46E5] text-[12.5px] font-semibold hover:bg-[#EEF2FF] transition-colors mt-1"
              >
                <Sparkles size={14} /> Ask AI to Draft Email
              </button>
            </div>
          </div>
        </div>
